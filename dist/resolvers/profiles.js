...
exports.deleteProfile = exports.createProfile = exports.getProfiles = void 0;
// Queries
async function getProfiles(root, args, context) {
    try {
        const { pool } = context;
...
//  Mutations
async function createProfile(root, args, context) {
    const { pool } = context;
    try {
...
async function deleteProfile(root, args, context) {
    const { pool } = context;
    try {
